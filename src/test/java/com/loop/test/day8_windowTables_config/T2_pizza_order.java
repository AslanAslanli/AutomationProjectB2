...
public class T2_pizza_order extends TestBase {
    ...
    public void test_pizza_type() {
        ...
        String expectedCardNumber = "VISA";
        String actualCardNumber = PizzaOrderWebTableUtils.returnAnyFieldValue(driver, name, "321456789012");
        assertEquals(actualCardNumber, expectedCardNumber, "actual does not match expected");

        String expectedExp = "VISA";
        String actualExp = PizzaOrderWebTableUtils.returnAnyFieldValue(driver, name, "02/24");
